...
weather.getWeather = function () {
    ...
    var lat = 'lat=' + parseInt(window.localStorage.getItem('lat') || 6);
    var lon = 'lon=' + parseInt(window.localStorage.getItem('lon') || 80);
    var api = 'APPID=0ad56c244434d4b3ec1cacb5dd73578c';

    fetch('' + link + lat + '&' + lon + '&' + api + '&units=metric').then(function (response) {
        ...
        document.getElementById('weather-temp').innerHTML = parseInt(weather.main.temp) + '\xB0C';
